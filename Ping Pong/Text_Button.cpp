...
Text_Button::Text_Button(const Graphics& graphics, const std::string& font_file_path, const std::string& button_text, int x_, int y_, int text_size, int vertical_padding, int horizontal_padding, SDL_Color button_color_, SDL_Color text_color_, bool horizontal_centered)
...
bool Text_Button::clicked() const
{
	int mouse_x = 0;
	int mouse_y = 0;
...
void Text_Button::draw(const Graphics& graphics)
{
